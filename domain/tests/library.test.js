...
describe('Library', () => {
  ...
  it('add a book to the library', () => {
    myLibrary.addBook('Cuentos de la Selva', 'Horacio Quiroga', 120, 8000);
  ...
  it('return the total number of books', () => {
    myLibrary.addBook('Cuentos de la Selva', 'Horacio Quiroga', 120, 8000);
    myLibrary.addBook('El Hombre que Calculaba', 'Malba Tahan', 286, 8000);
  ...
  it('throw an error when setting an empty name', () => {
    myLibrary.addBook('Cuentos de la Selva', 'Horacio Quiroga', 120, 8000);
    myLibrary.addBook('El Hombre que Calculaba', 'Malba Tahan', 286, 8000);
    expect(myLibrary.totalWords()).toBe(16000);
  });
